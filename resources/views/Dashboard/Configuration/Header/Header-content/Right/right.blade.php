                        ...
                        <div class="scroll-area-xs" style="height: 150px;">
                            <div class="scrollbar-container ps">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" tabindex="0" class="dropdown-item">Mensagens</button>
                                    </li>
                                    <li class="nav-item">
                                        <button type="button" tabindex="0" class="dropdown-item">Historico</button>
                                    </li>
                                    <h6 tabindex="-1" class="dropdown-header">Configurações</h6>
                                    <li class="nav-item">
                                        <button type="button" tabindex="0" class="dropdown-item">Usuario</button>
                                    </li>
                                    <li class="nav-item">
                                        <button type="button" tabindex="0" class="dropdown-item">Segurança</button>
                                    </li>
